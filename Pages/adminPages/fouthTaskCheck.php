                ...
                <div class="post">
                    <div class="story">
                        ...
                        if ($done) {
                            ...
                            echo $connect->getDateDone(4, $connect->getUserId($login, "users"), "taskdone");
                            ...
                            foreach ($dataSolver as $key => $value) {
                                ...
                                for ($index = 0; $index < count($yDataSolver); $index++) {
                                    echo '<td class="task">' . $yDataSolver[$index][0] . "</td>";
                                    echo '<td class="task">' . $yDataSolver[$index][1] . "</td>";
                                }
                            ...
                            if ($cont) {
                                ...
                                echo $connect->getDateDone(4, $connect->getUserId($login, "users"), "taskdone"), ".<br>";
                            }
                            $dataSolver = $connect->getTaskRezult(4, $connect->getUserId($login, "users"), "tasktable");
                            $dataSolver = unserialize($dataSolver);
                            foreach ($dataSolver as $key => $value) {
