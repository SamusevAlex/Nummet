...
<div id="mid">
            ...
            <div id="posts">
                <div class="post">
                    <div class="story">
                        <h3>Форма вставки функції в завдання 2</h3>
                        <div>Приклад опису функції: #alfa# * unk + #beta#</div>
                        <div class="varning">Необхідно додати нову формулу перетворення в код вирішувача</div>
                        <br>
                        <form action="" method="POST">
                            <div class='inTask'><label class='inputTask' for='n'>Функція</label><input type="text" id='n' class='function' name="func"></div>
                            <input type="submit" value="Вставити функцію" style="margin-left: 6%;">
                        </form>
                        <?php
                        if (isset($_POST['func'])) {
                            $func = htmlspecialchars($_POST['func']);
                            $connect = new SqlConnectNumMet(HOST, USER, PASSWORD, DB);
                            $connect->addFunctions($func, "functionsecondtask");
                        }
                        ?>
                    </div>
                </div>
