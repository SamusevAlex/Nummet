                ...
                <div class="post">
                    <div class="story">
                        <form action="deleteFunction.php" method="POST">
                            <div>
                                <label class="delete" for="education">
                                    Виберіть завдання
                                </label>
                                <select name="task" id="education">
                                    <option value='functionfirsttask'>  Перше завдання</option>
                                    <option value='functionsecondtask'> Друге завдання</option>
                                    <option value='functionthirdtask'> Третє завдання</option>
                                    <option value='functionfouthtask'> Четверте завдання</option>
                                    <option value='functionfifthtask'> П'яте завдання</option>
                                    <option value='functionsixthtask'> Шосте завдання</option>
                                </select>
                            </div>
                            <input type="submit" value="Вибрати функцію" style="margin-left: 6%;">
                        </form>
                    </div>
                </div>
            </div>
