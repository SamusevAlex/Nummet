...
if (isset($_POST['func'])) {
    $oldFunc = htmlspecialchars($_POST['func']);
    $connect->deleteFunctions($oldFunc, $_POST['task']);
    $done = 'Функция удалена';
}
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="story">
                        ...
                        <form action="" method="POST">
                            <div><label class="delete" for="education">
                                ...
                                <select id="education" class="delete" name="func">
                                    <?php
                                    $ar = $connect->getFunctions($_POST['task']);
                            ...
                            <input type="submit" value="Видалити" style="margin-left: 10%;">
                        </form>
                    </div>
                </div>
            </div>
