    ...
    <body>
        <div id="mid">
            ...
            <div id="posts">
                <div class="post">
                    <div class="story">
                        <h3>Форма вставки функції в завдання 1</h3>
                        <div>Приклад опису функції: 6/pow((unk+1),1.5)*cos(unk)+atan(unk)</div><br>
                        <form action="" method="POST">
                            <div class='inTask'><label class='inputTask' for='n'>Функция</label><input type="text" id='n' class='function' name="func"></div>
                        ...
                        if (isset($_POST['func'])) {
                            ...
                            $connect = new SqlConnectNumMet(HOST, USER, PASSWORD, DB);
                            $connect->addFunctions($func, "functionfirsttask");
                        }
                        ?>
                    </div>
                </div>
