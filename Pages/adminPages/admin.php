    ...
    <body>
        <div id="mid">
            ...
            <div id="posts">
                <div class="post">
                    <div class="story">
                        <a href="createNewAdmin.php">Зареєструвати нового адміністратора</a><br>
                        <a href="addFunction.php">Додати функцію</a><br>
                        <a href="deleteFunctionTask.php">Видалити функцію</a><br>
                        <?php
                        if ($reg = $connect->checkRegistration("setings")) {
                            echo '<a href="changeReg.php">Закрити реєстрацію</a><br>';
                        } else {
                            echo '<a href="changeReg.php">Відкрити реєстрацію</a><br>';
                        }
                        ?>

                        <a href="regGroup.php">Зареєструвати групу</a><br>
                        <a href="deleteGroup.php">Видалити групу</a><br>
                        <a href="taskCheck.php">Перевірити завдання</a><br>
                    </div>
                </div>
            </div>
        </div>
