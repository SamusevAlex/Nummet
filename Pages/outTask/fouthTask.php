            ...
            <div id="posts">
                <div class="post">
                    <div class="story">
                        ...
                        $b = $data["b"];
                        ?>
                        <div>Інтеграл заданий видом <img alt='integral' style="vertical-align: middle;" src="image/int.PNG">,
                        ...
                        <a href="download/fouthTask.php">Завантажити завдання</a><br>
                        <a href="download/downloadMethodFouthTask.php">Завантажити методичні вказівки</a><br>
                    </div>
                </div>
            </div>
        </div>
