            ...
            <div id="posts">
                <div class="post">
                    <div class="story">
                        ...
                        echo $gp;
                        ?>
                        <a href="download/thirdTask.php">Завантажити завдання</a><br>
                        <a href="download/downloadMethodThirdTask.php">Завантажити методичні вказівки</a><br>
                    </div>
                </div>
            </div>
        </div>
