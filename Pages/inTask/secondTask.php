                ...
                <div class="post">
                    <div class="story">
                        ...
                        if ($connect->isDone("2", $connect->getUserId($login, "users"), "taskdone")) {
                            echo '<div>Завдання виконано. <a href="../checkTask/secondTask.php">Перейти до сторінки відповіді</a></div>';
                        } else {
                        ...
                        //var_dump($data);
                        ?>
                        <form  action="../checkTask/secondTask.php" method="POST" enctype="multipart/form-data">
                            <div>Значення для емпіричної залежності з найменшим параметром помилки d</div>
                            <div class='inTask'><label class='inputTask' for='n'>Емпірична залежність</label><input type='text' id='n' class='poleInputTask' name='n'></div>
                            <div class='inTask'><label class='inputTask' for='alfa'>Альфа</label><input type='text' id='alfa' class='poleInputTask' name='alfa'></div>
                            <div class='inTask'><label class='inputTask' for='beta'>Бета</label><input type='text' id='beta' class='poleInputTask' name='beta'></div>
                            <div class='inTask'><label class='inputTask' for='d'>Помилка</label><input type='text' id='d' class='poleInputTask' name='d'></div>
                            <input type="submit" value="Перевірити" style="margin-left: 4%;">
                        </form>
                        <?php } ?>
                    </div>
                </div>
