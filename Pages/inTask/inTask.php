    ...
    <body>
        <div id="mid">
            ...
            <div id="posts">
                <div class="post">
                    <div class="story">
                        <a href="firstTask.php">Завдання 1. ІНТЕРПОЛЯЦІЯ</a><br>
                        <a href="secondTask.php">Завдання 2. АПРОКСИМАЦІЯ ФУНКЦІЙ, ЩО ЗАДАНІ ТАБЛИЦЕЮ</a><br>
                        <a href="thirdTask.php">Завдання 3. ІНТЕРПОЛЯЦІЯ ФУНКЦІЙ КУБІЧНИМИ СПЛАЙНАМИ</a><br>
                        <a href="fouthTask.php">Завдання 4. ЧИСЕЛЬНЕ ІНТЕГРУВАННЯ</a><br>
                        <a href="fifthTask.php">Завдання 5. ЧИСЕЛЬНЕ ДИФЕРЕНЦІЮВАННЯ</a><br>
                        <a href="sixthTask.php">Завдання 6. ЧИСЕЛЬНЕ РІШЕННЯ ЗВИЧАЙНИХ ДИФЕРЕНЦІАЛЬНИХ РІВНЯНЬ</a><br>
                    </div>
                </div>
            </div>
        </div>
